              ...
              <section>
                ...
                <section className="mx-4 mt-[20px]">
                  ...
                  <p className="text-[#FFF5EA] mt-2">
                    ...
                    Marketing Department as their Front End Web Developer
                    Intern.
                  </p>
              ...
              <section>
                ...
                <section className="mx-4 mt-[20px]">
                  ...
                  <p className="text-[#FFF5EA] mt-2">
                    ...
                    statistics under Web Development Department at HSI company
                    as their Front End Web Developer Intern.
                  </p>
                  {/* <Link to="/" className="btn btn-link">
                  read more
                </Link> */}
            ...
            >
              <section>
                <video
                  className="w-full h-[70%] rounded-t-md cursor-pointer"
                  controls
                  poster="/Thumbnails/HSI Logo TN.png"
                >
                  <source
                    src="/MP4/HSI Logo.mp4"
                    type="video/mp4"
                  />
            ...
            >
              <section>
                <video
                  className="w-full h-[70%] rounded-t-md cursor-pointer"
                  controls
                  poster="/Thumbnails/B1G BAY AREA TN.png"
                >
                  <source
                    src="/MP4/B1G BAY AREA.mp4"
                    type="video/mp4"
                  />
                  Your browser does not support the video tag.
                </video>
